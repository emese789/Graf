/*4.1. Zárójelezés
Egy gráf mélységi bejárása alkalmával a csúcsok elérési és elhagyási
id®pontjait zárójeles szerkezettel ábrázolhatjuk. Más szóval, ha minden
szürkére festéskor nyitunk egy zárójelt és minden feketére váltáskor zárunk egyet, akkor n csomópont esetén egy 2n elem¶ helyesen záruló
zárójelsort kapunk.*/
#include <stdio.h>
#include <stdlib.h>
